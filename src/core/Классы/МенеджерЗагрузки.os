...
Процедура Загрузить(ОбъектыКЗагрузке) Экспорт
	...
	Если ПоказатьСписокОбъектовЗагрузки(ИмяФайлаСпискаОбъектов) Тогда
		...
		ПараметрыСтрокиСоединения.ПутьКФайлуБазы = Параметры.База.ПутьКФайлуБазы;
		ПараметрыСтрокиСоединения.Сервер         = Параметры.База.Сервер;
		ПараметрыСтрокиСоединения.Порт           = Параметры.База.Порт;
		ПараметрыСтрокиСоединения.ИмяБазы        = Параметры.База.Имя;
		Конфигуратор.УстановитьКонтекст(ПараметрыСтрокиСоединения, Параметры.База.Пользователь, Параметры.База.Пароль);
