...
Функция ПолучитьСписокИзмененныхФайлов() Экспорт
	...
	КонецЦикла;
	Возврат ЗаписатьВоВременныйФайл(НормализоватьИмена(ДополнитьПутиГит(Массив)));
КонецФункции
...
Функция ПолучитьСписокПоКоличествуКоммитов(СмещениеПервогоКоммита, СмещениеВторогоКоммитаИлиСсылка = "") Экспорт
	...
	КонецЕсли;
	Вывод = ВыполнитьКоманду(КоманднаяСтрока);
	Возврат ЗаписатьВоВременныйФайл(НормализоватьИмена(ДополнитьПутиГит(Вывод)));
КонецФункции
...
Функция СформироватьСписок(мОбъекты) Экспорт
	...
	Возврат ЗаписатьВоВременныйФайл(мСписокФайлов);
...
Функция ЗаписатьВоВременныйФайл(Текст)
	
	Если ПустаяСтрока(Текст) Тогда
		Возврат "";
	КонецЕсли;
	
	ИмяВременногоФайла = ИмяФайлаСпискаОбъектовПоУмолчанию();
